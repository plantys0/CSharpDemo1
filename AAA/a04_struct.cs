...
namespace AAA
{
    public class a04_struct
    {
        ...
        // **Struct with Members**: Fields, methods, etc. Now with overloaded ctors.
        struct Person
        {
            public string Name;
            public int Age;

            // Overloaded Constructor 1: Takes name and age.
            ...
            // Overloaded Constructor 2: Takes only name, sets age to 0.
        ...
        class Program
        {
            static void Main()
            {
                ...
                // **Struct Members & Constructors** (with overloads)
                Console.WriteLine("\n**Struct Members with Overloaded Ctors**");
                Person p1 = new Person("Alice", 30);  // Uses overload with name and age
                p1.Print();  // Name: Alice, Age: 30

                Person p2 = new Person("Bob");  // Uses overload with only name
                p2.Print();  // Name: Bob, Age: 0
